...
+----------------------------------------------+----------------------+
| spec_configSource_configMap_kubeletConfigKey | <string>             |
+----------------------------------------------+----------------------+
| spec_configSource_configMap_name             | <string>             |
+----------------------------------------------+----------------------+
| spec_configSource_configMap_namespace        | <string>             |
+----------------------------------------------+----------------------+
| spec_configSource_configMap_resourceVersion  | <string>             |
+----------------------------------------------+----------------------+
| spec_configSource_configMap_uid              | <string>             |
+----------------------------------------------+----------------------+
| spec_externalID                              | <string>             |
+----------------------------------------------+----------------------+
| spec_podCIDR                                 | <string>             |
+----------------------------------------------+----------------------+
