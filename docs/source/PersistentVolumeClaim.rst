...
+--------------------------+-----------------------+
| spec_dataSource_apiGroup | <string>              |
+--------------------------+-----------------------+
| spec_dataSource_kind     | <string>              |
+--------------------------+-----------------------+
| spec_dataSource_name     | <string>              |
+--------------------------+-----------------------+
| spec_resources_limits    | <map[string]string>   |
+--------------------------+-----------------------+
| spec_resources_requests  | <map[string]string>   |
+--------------------------+-----------------------+
