...
+-------------------------------------+-------------------------+
| spec_maxReplicas                    | <integer>               |
+-------------------------------------+-------------------------+
| spec_minReplicas                    | <integer>               |
+-------------------------------------+-------------------------+
| spec_scaleTargetRef_apiVersion      | <string>                |
+-------------------------------------+-------------------------+
| spec_scaleTargetRef_kind            | <string>                |
+-------------------------------------+-------------------------+
| spec_scaleTargetRef_name            | <string>                |
+-------------------------------------+-------------------------+
| spec_targetCPUUtilizationPercentage | <integer>               |
+-------------------------------------+-------------------------+
