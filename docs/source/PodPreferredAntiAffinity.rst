...
| Key                                            | Type                          |
+================================================+===============================+
| podAffinityTerm_labelSelector_matchExpressions | <[]COMPONENT.MatchExpression> |
+------------------------------------------------+-------------------------------+
| podAffinityTerm_labelSelector_matchLabels      | <map[string]string>           |
+------------------------------------------------+-------------------------------+
| podAffinityTerm_namespaces                     | <[]string>                    |
+------------------------------------------------+-------------------------------+
| podAffinityTerm_topologyKey                    | <string>                      |
+------------------------------------------------+-------------------------------+
| weight                                         | <integer>                     |
+------------------------------------------------+-------------------------------+
