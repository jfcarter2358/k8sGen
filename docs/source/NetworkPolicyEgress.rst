...
+------------------------------------------------+---------------------+
| to_ipBlock_cidr                                | <string>            |
+------------------------------------------------+---------------------+
| to_ipBlock_except                              | <[]string>          |
+------------------------------------------------+---------------------+
| to_namespaceSelector_matchExpressions_key      | <string>            |
+------------------------------------------------+---------------------+
| to_namespaceSelector_matchExpressions_operator | <string>            |
+------------------------------------------------+---------------------+
| to_namespaceSelector_matchExpressions_values   | <[]string>          |
+------------------------------------------------+---------------------+
| to_namespaceSelector_matchLabels               | <map[string]string> |
+------------------------------------------------+---------------------+
| to_podSelector_matchExpressions_key            | <string>            |
+------------------------------------------------+---------------------+
| to_podSelector_matchExpressions_operator       | <string>            |
+------------------------------------------------+---------------------+
| to_podSelector_matchExpressions_values         | <[]string>          |
+------------------------------------------------+---------------------+
| to_podSelector_matchLabels                     | <map[string]string> |
+------------------------------------------------+---------------------+
