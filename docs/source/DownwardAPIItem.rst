...
| Key                            | Type      |
+================================+===========+
| fieldRef_apiVersion            | <string>  |
+--------------------------------+-----------+
| fieldRef_fieldPath             | <string>  |
+--------------------------------+-----------+
| mode                           | <integer> |
+--------------------------------+-----------+
| path                           | <string>  |
+--------------------------------+-----------+
| resourceFieldRef_containerName | <string>  |
+--------------------------------+-----------+
| resourceFieldRef_divisor       | <string>  |
+--------------------------------+-----------+
| resourceFieldRef_resource      | <string>  |
+--------------------------------+-----------+
