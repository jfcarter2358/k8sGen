...
| nodeName                  | <string> |
+---------------------------+----------+
| targetRef_apiVersion      | <string> |
+---------------------------+----------+
| targetRef_fieldPath       | <string> |
+---------------------------+----------+
| targetRef_kind            | <string> |
+---------------------------+----------+
| targetRef_name            | <string> |
+---------------------------+----------+
| targetRef_namespace       | <string> |
+---------------------------+----------+
| targetRef_resourceVersion | <string> |
+---------------------------+----------+
| targetRef_uid             | <string> |
+---------------------------+----------+
